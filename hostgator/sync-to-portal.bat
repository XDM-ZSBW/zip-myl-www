...
echo 🔄 Syncing staging content to portal...
echo 📝 This will build portal from staging and push to GitHub
echo.

REM Build portal from staging content
echo 🔧 Building portal from staging...
...
if "%status%"=="" (
    ...
    echo 💡 Staging and portal are already in sync.
    pause
    exit /b 0
)
...
set "commitMessage=Sync staging to portal - %timestamp%"
...
if %errorlevel% equ 0 (
    echo.
    echo ✅ Sync to portal completed successfully!
